            ...
            <div className="box1 w-full md:w-[600px] hidden lg:block">
                ...
                <div className="box2 w-full md:w-[600px] mx-auto">
                    ...
                    <div className='font-custom text-left font-normal text-[16px] sm:text-[20px] leading-[28px] sm:leading-[36px] text-[#0F172A] mt-4 sm:mt-14'>
                        Tune in to the daily live streams to watch our experienced trading coaches discuss the Forexyy  market. Watch them at what they do best, analyze the financial markets with them, and ask any questions throughout!
                    </div>
